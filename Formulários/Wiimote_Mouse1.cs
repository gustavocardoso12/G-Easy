...
namespace MiniPaint
{
    public partial class Wiimote_Mouse1 : Form
    {
       ...
       Byte VK_TAB	= 0x09;
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            label1.Text = "Giroscópio Desativado";
        ...
        public void WiiControl(WiimoteState ws)
        {
            ...
            else
            {
                if (isBDown)
                {
                    label1.Text = "Gyroscópio desligado";
                    isBDown = false;
                }
            }
